...
A ideia do projeto é desenvolver uma aplicação de catalogo para a loja virtual, esse projeto podendo ser portado para outras lojas virtuais que vendem pelo instagram ou ate mesmo para perfis como os de adoção de animais.

---
## Alunos

- **JOSE ZILDEMAR DO NASCIMENTO JUNIOR**
- **KENDRIKS TAMIRES DA PAIXAO MONTEIRO**
