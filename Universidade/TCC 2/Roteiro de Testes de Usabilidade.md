...
---
## 1. Objetivo do Teste
- **Avaliar a eficácia** das principais funcionalidades do sistema, do ponto de vista do usuário (sucesso nas tarefas).
- **Identificar pontos de fricção** na navegação e no fluxo de interação.
